...
public class Example {
    ...
    public static void main(String[] args) {
        String input = "Hi, he she her this is michael. Do you want to put it off? Take off";

        Analyzer a = getAnalyzer();
        ArrayList<String> ls3 = tokenizeString(a, input);
        for (String str : ls3) {
    ...
    public static Analyzer getAnalyzer(){
        String [] stoparr = {"a", "about", "above", "above", "across", "after", "afterwards", "again", "against", "all", "almost", 
            ...
            "none", "noone", "nor", "not", "nothing", "now", "nowhere", "of", "off", "often", "on", "once", "one", "only", "onto", 
        ...
        Set<String> stopwords = new TreeSet(Arrays.asList(stoparr));
